   ...
   function main($id, $mode)
   {
      ...
      switch($mode)
      {
         case 'overview':
            ...
            $sql = "SELECT page_id, page_title, page_name, last_modified
         ...
         case 'add':
         	...
         	if ( isset($_POST['submit']) ) {
         		...
         		$new_name = $_POST['page_name'];
         		$new_content = $_POST['page_content'];
         		
         		if ( $new_title == '' || $new_name == '' || $new_content == '' ) {
         			trigger_error('None of the fields can be empty!' . adm_back_link($this->u_action), E_USER_WARNING);
         		}
